...
model = joblib.load('ML_Models/naive_bayes.pkl')
...
def home():
    ...
    if request.method == "POST":
        ...
        if not review_text.strip():
            return render_template("home.html", predictions=session["predictions"], error_message="Please enter a review text.")
    ...
    return render_template("home.html", predictions=session["predictions"])
